	...
	cmd.Flags = []cli.Flag{
		...
		&cli.StringFlag{
			...
			Sources: cli.NewValueSourceChain(
				...
				cli.EnvVar("REPOSITORY_BRANCH"),
				cli.File("/vela/parameters/slack/repo_branch"),
				cli.File("/vela/secrets/slack/repo_branch"),
			),
		},
		&cli.StringFlag{
			Name:  "repo-clone",
			...
			Sources: cli.NewValueSourceChain(
				...
				cli.EnvVar("REPOSITORY_CLONE"),
				cli.File("/vela/parameters/slack/repo_clone"),
				cli.File("/vela/secrets/slack/repo_clone"),
			),
		},
		&cli.StringFlag{
			Name:  "repo-full-name",
			...
			Sources: cli.NewValueSourceChain(
				cli.EnvVar("VELA_REPO_FULL_NAME"),
				cli.EnvVar("REPOSITORY_FULL_NAME"),
				cli.File("/vela/parameters/slack/repo_full_name"),
				cli.File("/vela/secrets/slack/repo_full_name"),
			),
		},
		&cli.StringFlag{
			Name:  "repo-link",
			...
			Sources: cli.NewValueSourceChain(
				cli.EnvVar("VELA_REPO_LINK"),
				cli.EnvVar("REPOSITORY_LINK"),
				cli.File("/vela/parameters/slack/repo_link"),
				cli.File("/vela/secrets/slack/repo_link"),
			),
		},
		&cli.StringFlag{
			Name:  "repo-name",
			...
			Sources: cli.NewValueSourceChain(
				...
				cli.EnvVar("REPOSITORY_NAME"),
				cli.File("/vela/parameters/slack/repo_name"),
				cli.File("/vela/secrets/slack/repo_name"),
			),
		},
		&cli.StringFlag{
			Name:  "repo-org",
			...
			Sources: cli.NewValueSourceChain(
				...
				cli.EnvVar("REPOSITORY_ORG"),
				cli.File("/vela/parameters/slack/repo_org"),
				cli.File("/vela/secrets/slack/repo_org"),
			),
		},
		&cli.StringFlag{
			Name:  "repo-private",
			...
			Sources: cli.NewValueSourceChain(
				cli.EnvVar("VELA_REPO_PRIVATE"),
				cli.EnvVar("REPOSITORY_PRIVATE"),
				cli.File("/vela/parameters/slack/repo_private"),
				cli.File("/vela/secrets/slack/repo_private"),
			),
		},
		&cli.IntFlag{
			Name:  "repo-timeout",
			...
			Sources: cli.NewValueSourceChain(
				cli.EnvVar("VELA_REPO_TIMEOUT"),
				cli.EnvVar("REPOSITORY_TIMEOUT"),
				cli.File("/vela/parameters/slack/repo_timeout"),
				cli.File("/vela/secrets/slack/repo_timeout"),
			),
		},
		&cli.StringFlag{
			Name:  "repo-trusted",
			...
			Sources: cli.NewValueSourceChain(
				cli.EnvVar("VELA_REPO_TRUSTED"),
				cli.EnvVar("REPOSITORY_TRUSTED"),
				cli.File("/vela/parameters/slack/repo_trusted"),
				cli.File("/vela/secrets/slack/repo_trusted"),
			),
		},
